...
public class MD5Utils{
    ...
    * */
    public  static  boolean verification(String inputPassword,String dbPassword) throws NoSuchAlgorithmException {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        String dbPassword = toHex(encryptionStr("abcdef"));
        String inputPassword = "abcdef";
        String inputPassword2 = "abcdeffff";
        System.out.println(verification(inputPassword,dbPassword));
        System.out.print(verification(inputPassword,inputPassword2));
    }
}
